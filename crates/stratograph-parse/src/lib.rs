...
mod tests {
    ...
    fn scrubs_secrets_from_comment_nodes() {
        use stratograph_core::{NodeId, NodeKind};
...
"#;
        ...
        check!(
            fg.graph
                .edges
                .iter()
                .any(|e| &e.dst == helper_id && e.kind == stratograph_core::EdgeKind::Calls)
        );
    }

    #[test]
    fn rest_endpoints_link_local_handlers() {
        use stratograph_core::{Confidence, EdgeKind, NodeId, NodeKind};
        let src = r#"
async fn list() {}
fn app() -> Router {
...
"#;
        ...
        check!(
            !rg.graph
                .edges
                .iter()
                .any(|e| e.kind == stratograph_core::EdgeKind::Handles)
        );
    ...
    fn rest_mounts_link_router_builders() {
        use stratograph_core::{Confidence, EdgeKind, NodeId};
        let src = r#"
async fn list() {}
