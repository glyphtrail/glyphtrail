...
//! Model Context Protocol server for Stratograph, over stdio.
//!
...
fn initialize_result() -> Value {
    json!({
        ...
        "capabilities": { "tools": {} },
        "serverInfo": { "name": "stratograph", "version": env!("CARGO_PKG_VERSION") },
    })
}
...
mod tests {
    ...
    fn initialize_advertises_tools_capability() {
        ...
        check!(resp["result"]["serverInfo"]["name"] == json!("stratograph"));
    }
